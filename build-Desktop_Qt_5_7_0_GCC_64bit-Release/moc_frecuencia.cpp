/****************************************************************************
** Meta object code from reading C++ file 'frecuencia.h'
**
...
#error "The header file 'frecuencia.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Frecuencia_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 20, 12) // "QVector<int>"
    ...
    "Frecuencia\0setData\0\0QVector<int>"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Frecuencia[] = {
...
void Frecuencia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Frecuencia *_t = static_cast<Frecuencia *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setData((*reinterpret_cast< QVector<int>(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject *Frecuencia::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Frecuencia::qt_metacast(const char *_clname)
{
